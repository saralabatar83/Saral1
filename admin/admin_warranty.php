...
if (isset($_POST['update_warranty'])) {
    ...
    $sql = "UPDATE warranty SET hero_title=?, hero_image=?, last_updated=?, content=? WHERE id=1";
...
// --- 2. FETCH DATA ---
$stmt = $pdo->query("SELECT * FROM warranty WHERE id = 1");
$row = $stmt->fetch(PDO::FETCH_ASSOC);

// Defaults if row doesn't exist
$heroTitle = $row['hero_title'] ?? 'Warranty Policy';
...
<head>
    <meta charset="UTF-8">
    <title>Admin | Warranty Policy</title>
    ...
    <style>
        ...
        h3 { margin-top: 0; color: #333; border-left: 4px solid #2e7d32; padding-left: 10px; margin-bottom: 20px; }
...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="admin_warranty.php" class="active"><i class="fas fa-shield-alt"></i> Warranty Policy</a></li>
...
<div class="main-content">
    <div class="container">
        ...
        <div class="header-row">
            <h2 style="margin:0;">Warranty Policy Manager</h2>
            <a href="../warranty_policy.php" target="_blank" class="btn-view">
        ...
        <form method="POST">
            <div class="card">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="last_updated" value="<?php echo htmlspecialchars($lastUpdated); ?>" placeholder="e.g. Updated Oct 2023">
                    </div>
                </div>

                <div class="form-group">
                    <label>Hero Banner Image URL</label>
                    <input type="text" name="hero_image" value="<?php echo htmlspecialchars($heroImage); ?>" placeholder="https://example.com/image.jpg">
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="form-group">
                    <label>Detailed Warranty Text (Rich Editor)</label>
                    <textarea name="content" id="warranty-editor"><?php echo $content; ?></textarea>
                </div>

                <button type="submit" name="update_warranty" class="btn-save">
                    <i class="fas fa-save"></i> Save Warranty Changes
                </button>
            </div>
        </form>
