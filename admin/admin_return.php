...
if (isset($_POST['update_return'])) {
    ...
    $sql = "UPDATE return_policy SET hero_title=?, hero_image=?, last_updated=?, content=? WHERE id=1";
...
// --- 2. FETCH DATA ---
$stmt = $pdo->query("SELECT * FROM return_policy WHERE id = 1");
$row = $stmt->fetch(PDO::FETCH_ASSOC);

// Defaults if row doesn't exist
$heroTitle = $row['hero_title'] ?? 'Return Policy';
...
<head>
    <meta charset="UTF-8">
    <title>Admin | Return Policy</title>
    ...
    <style>
        ...
        .btn-view { background: white; padding: 8px 15px; border-radius: 5px; text-decoration: none; color: #e65100; font-weight: bold; border: 1px solid #e65100; transition: 0.2s; }
        .btn-view:hover { background: #e65100; color: white; }

        .card { background: white; padding: 25px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); margin-bottom: 30px; }
        h3 { margin-top: 0; color: #333; border-left: 4px solid #e65100; padding-left: 10px; margin-bottom: 20px; }
        ...
        .btn-save:hover { background: #bf4500; box-shadow: 0 2px 8px rgba(0,0,0,0.2); }
...
<div class="sidebar">
    <h2><i class="fas fa-undo-alt"></i> ADMIN PANEL</h2>
    <ul>
        ...
        <li><a href="admin_return.php" class="active"><i class="fas fa-undo-alt"></i> Return Policy</a></li>
...
<div class="main-content">
    <div class="container">
        ...
        <div class="header-row">
            <h2 style="margin:0;">Return Policy Manager</h2>
            <a href="../return_policy.php" target="_blank" class="btn-view">
            ...
            <div class="card">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="last_updated" value="<?php echo htmlspecialchars($lastUpdated); ?>" placeholder="e.g. Updated March 2024">
                    </div>
                </div>

                <div class="form-group">
                    <label>Hero Banner Image URL</label>
                    <input type="text" name="hero_image" value="<?php echo htmlspecialchars($heroImage); ?>" placeholder="https://example.com/return-banner.jpg">
                </div>
            </div>

            <div class="card">
                <h3><i class="fas fa-file-alt"></i> Policy Content</h3>
                <div class="form-group">
                    <label>Main Return Policy Text (Rich Editor)</label>
                    <textarea name="content" id="return-editor"><?php echo $content; ?></textarea>
                </div>

                <button type="submit" name="update_return" class="btn-save">
                    <i class="fas fa-save"></i> Save Return Policy Changes
                </button>
            </div>
        </form>
