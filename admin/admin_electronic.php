...
if (isset($_GET['delete'])) {
    $id = (int)$_GET['delete'];
    $pdo->prepare("DELETE FROM electronic WHERE id = ?")->execute([$id]);
    header("Location: admin_electronic.php?msg=deleted");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_product'])) {
    ...
    // Fixed: Ensure all fields match the database table columns
    $data = [
        $_POST['brand_id'], 
        $_POST['sub_id'], 
        $_POST['title'], 
        $_POST['price'], 
        $_POST['title'], // Using title as short_desc to prevent crash
        $_POST['long_desc'], 
        $image, 
        $_POST['meta_title'], 
    ...
    header("Location: admin_electronic.php?msg=success"); 
    exit();
}
...
<head>
    ...
    <!-- Link to your original dashboard CSS -->
    <link rel="stylesheet" href="dashboard.css">
    
    <style>
        /* Essential layout styles */
        :root { --sidebar-width: 260px; }
        body { background: #f4f7f6; margin: 0; display: flex; font-family: 'Inter', sans-serif; }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="admin_electronic.php" class="active"><i class="fas fa-plug"></i> <span>Electronics</span></a></li>
            ...
            <li><a href="top_services.php"><i class="fas fa-star"></i> <span>Top Services</span></a></li>
