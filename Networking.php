...
<body>
    ...
    <div class="wrapper">
        ...
        <aside class="sidebar">
            ...
            <div class="filter-card">
                ...
                <div class="filter-list">
                    ...
                    <?php foreach($brands_list as $b): ?>
                        <a href="?brand_id=<?= $b['id'] ?>&cat_id=<?= $current_cat ?>" 
            ...
            <a href="Networking.php" class="reset-link"><i class="fa fa-sync-alt"></i> RESET ALL FILTERS</a>
        </aside>
            ...
            <div class="product-grid">
                ...
                <?php else: ?>
                    ...
                    <div class="product-card">
                        ...
                        <a href="networking-details.php?id=<?= $p['id'] ?>" class="btn-view">VIEW SPECS</a>
                    </div>
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
