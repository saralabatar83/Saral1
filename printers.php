    ...
    <div class="wrapper">
        ...
        <aside class="sidebar">
            <div class="filter-card">
                <div class="filter-title">Printer Categories</div>
                <div class="filter-list">
                    <a href="?sub_id=all&brand_id=<?= $curr_brand ?>" class="filter-item <?= ($curr_cat == 'all') ? 'active' : '' ?>">All Categories</a>
                    <?php foreach($subs_list as $s): ?>
                        <a href="?sub_id=<?= $s['id'] ?>&brand_id=<?= $curr_brand ?>" 
                           class="filter-item <?= ($curr_cat == $s['id']) ? 'active' : '' ?>">
            ...
            <div class="filter-card">
                ...
                <div class="filter-list">
                    <a href="?brand_id=all&sub_id=<?= $curr_cat ?>" class="filter-item <?= ($curr_brand == 'all') ? 'active' : '' ?>">All Brands</a>
                    <?php foreach($brands_list as $b): ?>
                        <a href="?brand_id=<?= $b['id'] ?>&sub_id=<?= $curr_cat ?>" 
                           class="filter-item <?= ($curr_brand == $b['id']) ? 'active' : '' ?>">
                           <?= htmlspecialchars($b['brand_name']) ?>
                        </a>
                    <?php endforeach; ?>
                </div>
            </div>
            <a href="printers.php" class="reset-link"><i class="fa fa-sync-alt"></i> RESET FILTERS</a>
        </aside>
            ...
            <div class="product-grid">
                ...
                <?php else: ?>
                    ...
                    <div class="product-card">
                        ...
                        <a href="printer-details.php?id=<?= $p['id'] ?>" class="btn-view">VIEW DETAILS</a>
                    </div>
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
